...
const AccountSideBar: FC<AccountSideBarProps> = ({}) => {
  ...
  return (
    <aside className="w-full bg-white m-3 rounded-lg max-w-[10rem] px-1">
          ...
          <Link
            className={`${
              pathname === link
                ...
                : ""
            } w-full relative group py-2 pl-8 mt-3 overflow-hidden flex justify-between items-center font-medium text-sm text-slate-500/70 hover:text-slate-950 hover:font-extrabold hover:bg-slate-300 transition duration-300`}
            href={link}
          >
